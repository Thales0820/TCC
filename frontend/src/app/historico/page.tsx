    ...
    const obrasData = [
        {
          ...
          capitulos: [
            { id: 1, numero: '1123', titulo: ' As 2 semanas em branco' },
            { id: 2, numero: '1122', titulo: 'O Momento Certo' },
            { id: 3, numero: '1121', titulo: ' O fluxo constante das eras' },
          ],
        },
        {
          id: 24,
          ...
          capitulos: [
            { id: 4, numero: '128', titulo: ' O Dia em que Você Desapareceu' },
          ],
        },
        {
          id: 22,
          ...
          capitulos: [
            { id: 5, numero: '91', titulo: 'Deus da Espada vs Demônio da Espada' },
            { id: 6, numero: '90', titulo: ' Formas Variantes' },
          ],
        },
        {
          id: 15,
          ...
          capitulos: [
            { id: 7, numero: '3', titulo: 'Zodd, o Nosferatu (2)' },
            { id: 8, numero: '2', titulo: 'Zodd, o Nosferatu (1)' },
            { id: 9, numero: '1', titulo: 'Ventos da Espada' },
          ],
        },
    ];
